...
<form action="" method="post">
	...
	<table class="form-table">
		...
		<tr>
			<th scope="row">
				<label for="service-capacity"><?php _e( 'Servicekapazität', 'appointments' ); ?></label>
			</th>
            <td>
...
<?php } else { ?>
				<input id="service-capacity" type="number" name="service_capacity" value="" min="0" max="<?php echo esc_attr( $number_of_workers ); ?>" style="width: 80px;" />
...
?>
	...
	<?php submit_button( __( 'Speichern', 'appointments' ) ); ?>
</form>
