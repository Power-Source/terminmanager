...
<form action="" method="post" class="add-new-service-provider">
	<table class="form-table">
		...
		<tr>
			...
			<td>
				<input id="worker-dummy" class="switch-button" type="checkbox" name="dummy" data-on="<?php esc_html_e( 'Ja', 'appointments' ); ?>" data-off="<?php esc_html_e( 'Nein', 'appointments' ); ?>"/>
			</td>
		</tr>
		<tr>
			<th scope="row">
				<label for="worker-price"><?php _e( 'Zusätzlicher Preis', 'appointments' ); ?></label>
			</th>
			<td>
		...
		<tr>
			<th scope="row">
				<label for="worker-services"><?php _e( 'Erbrachte Dienstleistungen', 'appointments' ); ?></label>
			</th>
			<td>
<?php
if ( $services ) {
?>
                    <label for="services_provided" class="screen-reader-text"><?php _e( 'Erbrachte Dienstleistungen', 'appointments' ); ?></label>
...
foreach ( $services as $service ) {
	...
	esc_html_e( 'Keine Dienste definiert', 'appointments' );
}
?>
			</td>
		</tr>
		<tr>
			<th scope="row">
				<label for="worker-page"><?php _e( 'Beschreibungsseite', 'appointments' ); ?></label>
			</th>
			<td>
	...
	<?php submit_button( __( 'Neuen Dienstanbieter hinzufügen', 'appointments' ) ); ?>
</form>
